            ...
            <div className="ml-10 flex items-baseline space-x-4  ">
              {['about', 'skills', 'projects', 'contact'].map((item) => (
                <button
                  ...
                  className="group relative text-gray-300 hover:text-cyan-400 px-4 py-2 rounded-md text-sm font-bold transition-all duration-300 capitalize font-mono cursor-pointer"
                >
