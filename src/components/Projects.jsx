  ...
  const projects = [
    {
      ...
      description: "A quiz application built with React featuring timer, scoring, and progress bar functionalities. Responsive and interactive.",
      tech: ["React.js", "Tailwind CSS", "JavaScript"],
      link: "https://quiz-app-nine-sand.vercel.app/",
      github: "https://github.com/KhaliqueAhmed/quiz-app",
      image: "/portfolio-placeholder.jpg"
    },
    {
      title: "Redux Cart App",
      description: "A minimal shopping cart app built using Redux Toolkit. Users can add or remove items, view total price, and see a clean state-managed cart system",
      tech: ["React", "Tailwind CSS", "RTK"],
      link: "https://redux-cart-app-zeta.vercel.app/",
      github: "https://github.com/KhaliqueAhmed/redux-cart-app",
      image: "/applaunch-placeholder.jpg"
    },
    {
      title: "CineScope",
      description: "CineScope is a movie discovery web app where users can browse trending movies, view detailed movie info, and manage their favorites.",
      tech: ["React.js", "Tailwind CSS", "Material UI", "Redux"],
      link: "https://cinescopeweb.netlify.app/",
      github: "https://github.com/KhaliqueAhmed/cineScope",
      image: "/academic-placeholder.jpg"
    },
    {
      title: "Delish–Restaurant Cafe ",
      description: "A pixel-perfect restaurant website built from a Figma template. Fully responsive with modern UI/UX. Includes pages for Home, Menu, About, and Reservation.",
      tech: ["React.js",  "Tailwind CSS"],
      link: "https://cafe-five-bice.vercel.app/",
      github: "https://github.com/KhaliqueAhmed/cafe",
