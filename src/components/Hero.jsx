...
const Hero = () => {
  ...
  const texts = ['Computer Engineer', 'React Frontend Developer', 'Problem Solver']
    ...
    <section className="min-h-screen flex items-center justify-center pt-16 bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pb-16 sm:pb-20">
        ...
        <div className="flex justify-center space-x-6">
          <a href="https://github.com/khaliqueahmed" target="_blank" rel="noopener noreferrer" 
          ...
          <a href="https://www.linkedin.com/in/khaliqueahmedchandio/" target="_blank" rel="noopener noreferrer" 
          ...
          <a href="mailto:khaleequeahmed4@gmail.com" 
