      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-300 text-base sm:text-lg mb-8 leading-relaxed font-mono">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <a href="mailto:khaleequeahmed4@gmail.com" className="text-cyan-400 hover:text-cyan-300 transition-colors font-mono break-all">
                    khaleequeahmed4@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <a href="tel:+923452083660" className="text-cyan-400 hover:text-cyan-300 transition-colors font-mono">
                    +92 345 2083660
                  </a>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-wrap gap-3">
                <a href="https://github.com/khaliqueahmed" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800/50 hover:bg-gray-700/70 rounded-lg flex items-center justify-center transition-all duration-300 border border-gray-600/50 hover:border-cyan-400/60 hover:scale-110">
                ...
                <a href="https://www.linkedin.com/in/khaliqueahmedchandio/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800/50 hover:bg-gray-700/70 rounded-lg flex items-center justify-center transition-all duration-300 border border-gray-600/50 hover:border-blue-400/60 hover:scale-110">
                  <svg className="w-5 h-5 text-gray-400 hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="https://khalique.vercel.app/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800/50 hover:bg-gray-700/70 rounded-lg flex items-center justify-center transition-all duration-300 border border-gray-600/50 hover:border-green-400/60 hover:scale-110">
